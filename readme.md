...
> A lightweight object validation which is developed base on the complex validation logic.
...
* Separate the validation of each context 
* Customize / Self-Defined new functions, conditions, and/or validation rules to your system
...
2. **Configuration**, which represents the logics, and conditions to create validation rules 
